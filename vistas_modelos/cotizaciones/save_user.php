...
$sql = "insert into cotizaciones (cod_cotizacion,fecha_cotizacion,hoja_trabajo,nombre_creador,cliente,sucursal,marca,modelo,serie,repuestos,valor,ejecucion,cod_orden_compra,cod_factura) values('$cod_cotizacion','$fecha_cotizacion','$hoja_trabajo','$nombre_creador','$cliente','$sucursal','$marca','$modelo','$serie','$repuestos','$valor','$ejecucion','$cod_orden_compra','$cod_factura')";
