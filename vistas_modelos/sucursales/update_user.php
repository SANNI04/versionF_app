...
$sql = "update sucursal_cliente set nombre_sucursal='$nombre_sucursal',identificacion_cliente='$identificacion_cliente',direccion='$direccion',contacto_cliente='$contacto_cliente' where index_id=$index_id";
