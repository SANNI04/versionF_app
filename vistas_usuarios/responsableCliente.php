...
<head>
    ...
    <title>Responsable_Cliente</title>
</head>

<body>
    <section class="header">
        <div class="logo">
            <a class="ri-menu-line icon icon-0 menu" href="../main3.php" style="color:yellow"> Menu Principal</a>
        </div>
    ...
    <section class="main">
        ...
        <br><br>
            <div class="recent--patients">
                <div class="title">
                    <h2 class="section--title">RESPONSABLE CLIENTE</h2>
                </div>                   
                <br><br><br>
                    ...
                    <script>
                        $(document).ready(()=>{
                        $('#contenedor--crud').load('../vistas_modelos/responsableCliente/index.php');
                        })
                    </script>
            </div>
        </div>
